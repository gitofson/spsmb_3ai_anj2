...
public class Strings01 {
    ...
    //String - konstatní, nelze měnit -> rychlý
    //StringBuffer - měnitělný -> pomalejší
    //zásadní odlišnost do ostatních objektů - lze vyrobit instancí bez operátorů new
    //1. prvek má index 0;
    //Vytvoření řetězce:
    public static void main(String[] args) {
        ...
        System.out.format("s1:%s, s2:%s, s3:%s%ns4, s5:%s, s6:%s%ns7:%s%n", s1, s2, s3, s4, s5, s6, s7);
        //Zjištění délky řetězce:
        System.out.format("délka s7:%d%n", s7.length());
        //Práce s řetězci
        //porovnání dvou řetěžců
        //pokud je řetězec v paramatru lexikálně větší (>), vrací zápornou hodnotu
        ...
        System.out.println("\r\n\t ahoj\t\r\n".trim());
        //nalezení znaků v řetězci
        String tmps1 = "malá a VELKA";
